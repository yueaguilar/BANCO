...
export declare class CallSummaryAgentSessionSummary {
    "sessionId"?: string;
...
export declare class CallSummaryCrelayInterruptions {
    "customerToAgent"?: number;
    "agentToCustomer"?: number;
    constructor(payload: any);
}
export declare class CallSummaryCrelayRateStats {
    "min"?: number;
    "max"?: number;
    "avg"?: number;
    constructor(payload: any);
...
export declare class CallSummaryCrelayTokenStats {
    "total"?: number;
    "tokensPerSecond"?: CallSummaryCrelayRateStats;
    constructor(payload: any);
}
export declare class CallSummaryCrelayWordStats {
    "total"?: number;
...
export declare class CallSummariesInstance {
    ...
    toJSON(): {
        ...
        trust: any;
        annotation: any;
        agentSessionSummaries: CallSummaryAgentSessionSummary[];
    };
