...
export declare class CallWrapUpEvent {
    /**
     * Duration in seconds.
     */
...
export declare class ConfigurationEvent {
     ...
     */
    "languages"?: {
        [key: string]: ConfigurationEventLanguagesValue;
    };
    constructor(payload: any);
}
export declare class ConfigurationEventLanguagesValue {
    "ttsProvider"?: string;
    "voice"?: string;
 ...
 */
export declare class InsightsV1CallEventConversationRelayData {
    /**
...
export declare class InterruptEvent {
    /**
...
export declare class LanguageChangedEvent {
    "ttsLanguageCode"?: string;
    "transcriptionLanguageCode"?: string;
    constructor(payload: any);
}
export declare class LastTokenReceivedEvent {
    /**
...
export declare class LatencyEvent {
    /**
