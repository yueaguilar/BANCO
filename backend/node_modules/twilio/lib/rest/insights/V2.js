...
const inboundReport_1 = require("./v2/inboundReport");
const outbound_1 = require("./v2/outbound");
const outboundReport_1 = require("./v2/outboundReport");
...
class V2 extends Version_1.default {
    ...
    get inboundReports() {
        this._inboundReports =
            this._inboundReports || (0, inboundReport_1.InboundReportListInstance)(this);
    ...
    get outboundReports() {
        this._outboundReports =
            this._outboundReports || (0, outboundReport_1.OutboundReportListInstance)(this);
