...
export declare class ParticipantInstance {
    ...
    constructor(_version: V2, _payload: ParticipantResource, conversationId: string, id?: string);
    /**
     * Participant ID.
     */
    id: string;
...
export declare function ParticipantListInstance(version: V2, conversationId: string): ParticipantListInstance;
