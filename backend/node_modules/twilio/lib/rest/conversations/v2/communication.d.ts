 ...
 */
export type ConversationsV2RecipientDeliveryStatus = "INITIATED" | "IN_PROGRESS" | "DELIVERED" | "READ" | "COMPLETED" | "FAILED";
...
export declare class CreateCommunicationInConversationRequestRecipients {
    "address": string;
    /**
     * Channel type for a Communication address.
     */
...
export declare class CommunicationContextImpl implements CommunicationContext {
    ...
    constructor(_version: V2, conversationId: string, id: string);
    fetch(callback?: (error: Error | null, item?: CommunicationInstance) => any): Promise<CommunicationInstance>;
    fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<CommunicationInstance>) => any): Promise<ApiResponse<CommunicationInstance>>;
    /**
     * Provide a user-friendly representation
...
export declare class CommunicationInstance {
    ...
    constructor(_version: V2, _payload: CommunicationResource, conversationId: string, id?: string);
    /**
     * Communication ID.
     */
    id: string;
...
export declare function CommunicationListInstance(version: V2, conversationId: string): CommunicationListInstance;
