 ...
 */
export declare class KnowledgeErrorGroup {
    /**
 ...
 */
export declare class KnowledgeErrorInstance {
    /**
 ...
 */
export type SupportedFileMimeType = "text/csv" | "text/markdown" | "application/pdf" | "text/tab-separated-values" | "text/plain";
/**
