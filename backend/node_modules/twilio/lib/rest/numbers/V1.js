...
const smsVerification_1 = require("./v1/smsVerification");
const smsVerificationCheck_1 = require("./v1/smsVerificationCheck");
const voiceVerification_1 = require("./v1/voiceVerification");
const voiceVerificationCheck_1 = require("./v1/voiceVerificationCheck");
...
class V1 extends Version_1.default {
    ...
    get smsVerifications() {
        this._smsVerifications =
            this._smsVerifications || (0, smsVerification_1.SmsVerificationListInstance)(this);
    ...
    get smsVerificationChecks() {
        this._smsVerificationChecks =
            this._smsVerificationChecks || (0, smsVerificationCheck_1.SmsVerificationCheckListInstance)(this);
        return this._smsVerificationChecks;
    }
    /** Getter for voiceVerifications resource */
    get voiceVerifications() {
        this._voiceVerifications =
            this._voiceVerifications || (0, voiceVerification_1.VoiceVerificationListInstance)(this);
    ...
    get voiceVerificationChecks() {
        this._voiceVerificationChecks =
            this._voiceVerificationChecks || (0, voiceVerificationCheck_1.VoiceVerificationCheckListInstance)(this);
